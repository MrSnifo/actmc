...
class WorldBorder:
    ...
    def from_coordinates(cls, center_x: float, center_z: float, current_diameter: float,
        ...
        """
        return cls(Vector2D(center_x, center_z), current_diameter, target_diameter,
                   speed, portal_teleport_boundary, warning_time, warning_blocks)
    ...
    def __repr__(self) -> str:
        ...
        return (f"<WorldBorder center={self.center}, "
                f"diameter={self.current_diameter}, target={self.target_diameter}>")
    ...
    def __eq__(self, other) -> bool:
        ...
        return (self.center == other.center and
                self.current_diameter == other.current_diameter and
                self.target_diameter == other.target_diameter)